...
<div class="relative w-full h-full">
  <div
    class="absolute top-[-6rem] left-1/4 w-[40vw] h-[33vh] bg-[#D9FDCA] bg-opacity-70 rounded-full blur-[5rem] transform -translate-x-1/2 z-[-1]"
  ></div>

  <div
    class="absolute top-1/4 right-[-6rem] w-[40vw] h-[17vh] bg-[#D8F7FF] rounded-full blur-[5rem] z-[-1]"
  ></div>

  <div
    class="absolute top-1/2 left-1/4 w-[60vw] h-[50vh] bg-[#D8F7FF] bg-opacity-70 rounded-full blur-[5rem] transform -translate-x-1/2 z-[-1]"
  ></div>
