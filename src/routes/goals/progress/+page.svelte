...
<div class="max-w-7xl mx-auto px-18 py-8">
    ...
    <h2 class="text-2xl font-bold mb-4">Progress</h2>
        <p class="text-lg text-gray-700 mb-4">
            Your weekly goal: <span class="font-bold">Have two meatless meals in a week</span>
        </p>
    <hr class="mb-6 border-gray-300" />

    <div class="bg-white p-6 rounded-lg shadow-md flex justify-between mb-8 max-w-3xl">
        <div class="w-1/2">
            <span class="block text-gray-700 mb-2">Your progress this week</span>
            <div class="w-full bg-gray-200 rounded-full h-4">
                <div class="bg-gradient-to-r from-[#D9FDCA] to-[#57DD7B] h-4 rounded-full" style="width: 50%;"></div>
            </div>
        </div>
